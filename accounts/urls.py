...
urlpatterns = [
    ...
    path('upload_qr/', views.upload_csv, name='upload_qr_page'),  # CSV Upload & QR Generation
    path('download_qr_zip/', views.download_all_qr_codes, name='download_qr_zip'),  # Download ZIP of QR codes
    ...
    path('qr/<int:qr_id>/', views.display_qr_data, name='display_qr_data'),
